...
export default function Header() {
  return (
    <header className="w-full bg-[url('/hero-bg.png')] bg-cover bg-center bg-fixed text-[#232323] border-b border-[#b7c9c9] sticky top-0 z-50 shadow-sm">
      <nav className="max-w-6xl mx-auto flex items-center justify-between px-4 py-3" style={{background: 'rgba(231,216,201,0.95)', borderRadius: '0 0 1rem 1rem'}}>
