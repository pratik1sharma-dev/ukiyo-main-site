...
const projects = [
  ...
  },
  {
    ...
    fullDescription: "A luxury residential interior design project in Gurgaon spanning 1300 square feet for a 4 BHK residence. The design transforms living spaces into sophisticated, elegant environments, combining contemporary aesthetics with premium materials and finishes. The spaces reflect refined taste and modern luxury while maintaining warmth and character.",
    images: [
